...
(library Library_1
	...
	(compDef "AP7362-33SP-13" (originalName "AP7362-33SP-13") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		...
		(compPin "8" (pinName "ADJ/NC") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "OUT_3") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "OUT_2") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "OUT_1") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://www.diodes.com//assets/Datasheets/AP7362.pdf")
		(attr "<Component Height>" "1.5")
		(attr "<STEP Filename>" "AP7362-33SP-13.stp")
